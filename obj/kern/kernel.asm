...
f01008c5:	89 45 c0             	mov    %eax,-0x40(%ebp)
...
f01008cb:	89 45 bc             	mov    %eax,-0x44(%ebp)
	while (ebp != 0)
f01008ce:	eb 05                	jmp    f01008d5 <mon_backtrace+0x3b>
		if (ret == 0){
			cprintf("%s:%d: %.*s+%d\n",
					info.eip_file, info.eip_line, info.eip_fn_namelen, info.eip_fn_name, eip - info.eip_fn_addr);
		}
		ebp = ptr_ebp[0];
f01008d0:	8b 45 c4             	mov    -0x3c(%ebp),%eax
f01008d3:	8b 30                	mov    (%eax),%esi
	while (ebp != 0)
f01008d5:	85 f6                	test   %esi,%esi
f01008d7:	74 56                	je     f010092f <mon_backtrace+0x95>
		ptr_ebp = (uint32_t *)ebp;
f01008d9:	89 75 c4             	mov    %esi,-0x3c(%ebp)
		eip = ptr_ebp[1];
f01008dc:	8b 7e 04             	mov    0x4(%esi),%edi
		cprintf("ebp %x  eip %x  args %08x %08x %08x %08x %08x\n",
f01008df:	ff 76 18             	pushl  0x18(%esi)
f01008e2:	ff 76 14             	pushl  0x14(%esi)
f01008e5:	ff 76 10             	pushl  0x10(%esi)
f01008e8:	ff 76 0c             	pushl  0xc(%esi)
f01008eb:	ff 76 08             	pushl  0x8(%esi)
f01008ee:	57                   	push   %edi
f01008ef:	56                   	push   %esi
f01008f0:	ff 75 c0             	pushl  -0x40(%ebp)
f01008f3:	e8 fc 01 00 00       	call   f0100af4 <cprintf>
		int ret = debuginfo_eip(eip, &info);
f01008f8:	83 c4 18             	add    $0x18,%esp
f01008fb:	ff 75 bc             	pushl  -0x44(%ebp)
f01008fe:	57                   	push   %edi
f01008ff:	e8 f4 02 00 00       	call   f0100bf8 <debuginfo_eip>
		if (ret == 0){
f0100904:	83 c4 10             	add    $0x10,%esp
f0100907:	85 c0                	test   %eax,%eax
f0100909:	75 c5                	jne    f01008d0 <mon_backtrace+0x36>
			cprintf("%s:%d: %.*s+%d\n",
f010090b:	83 ec 08             	sub    $0x8,%esp
f010090e:	2b 7d e0             	sub    -0x20(%ebp),%edi
...
f01009b0:	8d 83 b2 0b ff ff    	lea    -0xf44e(%ebx),%eax
...
f01009bc:	83 c4 10             	add    $0x10,%esp
	...
	{
		buf = readline("K> ");
f01009bf:	8d 83 a9 0b ff ff    	lea    -0xf457(%ebx),%eax
...
f0100a5a:	8d 83 cf 0b ff ff    	lea    -0xf431(%ebx),%eax
...
f0100c12:	8d 83 70 0d ff ff    	lea    -0xf290(%ebx),%eax
...
f0100c6a:	c7 c0 94 22 10 f0    	mov    $0xf0102294,%eax
f0100c70:	c7 c2 38 60 10 f0    	mov    $0xf0106038,%edx
...
f0100cbb:	c7 c0 94 22 10 f0    	mov    $0xf0102294,%eax
...
f0100cdd:	c7 c1 94 22 10 f0    	mov    $0xf0102294,%ecx
f0100ce3:	8d 0c 91             	lea    (%ecx,%edx,4),%ecx
f0100ce6:	8b 11                	mov    (%ecx),%edx
f0100ce8:	89 55 c0             	mov    %edx,-0x40(%ebp)
f0100ceb:	c7 c2 c4 79 10 f0    	mov    $0xf01079c4,%edx
f0100cf1:	81 ea 39 60 10 f0    	sub    $0xf0106039,%edx
...
f0100cff:	81 c2 39 60 10 f0    	add    $0xf0106039,%edx
...
f0100d38:	c7 c0 94 22 10 f0    	mov    $0xf0102294,%eax
...
f0100d5a:	c7 c1 94 22 10 f0    	mov    $0xf0102294,%ecx
...
f0100d7b:	8d 83 7a 0d ff ff    	lea    -0xf286(%ebx),%eax
f0100d81:	50                   	push   %eax
f0100d82:	6a 7f                	push   $0x7f
f0100d84:	8d 83 87 0d ff ff    	lea    -0xf279(%ebx),%eax
...
f0100df7:	c7 c2 94 22 10 f0    	mov    $0xf0102294,%edx
...
f0100e0f:	c7 c0 94 22 10 f0    	mov    $0xf0102294,%eax
f0100e15:	8b 14 90             	mov    (%eax,%edx,4),%edx
f0100e18:	c7 c0 c4 79 10 f0    	mov    $0xf01079c4,%eax
f0100e1e:	81 e8 39 60 10 f0    	sub    $0xf0106039,%eax
f0100e24:	39 c2                	cmp    %eax,%edx
f0100e26:	73 b4                	jae    f0100ddc <debuginfo_eip+0x1e4>
		info->eip_file = stabstr + stabs[lline].n_strx;
f0100e28:	81 c2 39 60 10 f0    	add    $0xf0106039,%edx
...
f0100f2f:	0f be 84 06 95 0d ff 	movsbl -0xf26b(%esi,%eax,1),%eax
f0100f36:	ff 
...
f0100fdd:	03 8c 83 24 0e ff ff 	add    -0xf1dc(%ebx,%eax,4),%ecx
...
f01010b3:	8d 83 b6 0d ff ff    	lea    -0xf24a(%ebx),%eax
...
f01010cf:	8d 83 ad 0d ff ff    	lea    -0xf253(%ebx),%eax
...
f01010fa:	8d 83 a6 0d ff ff    	lea    -0xf25a(%ebx),%eax
...
f01014b3:	8d 83 b6 0d ff ff    	lea    -0xf24a(%ebx),%eax
...
f01014dd:	8d 83 7c 0f ff ff    	lea    -0xf084(%ebx),%eax
